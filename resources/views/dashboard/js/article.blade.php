...
<script>
    $(document).ready(function () {
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: res => {
                            ...
                            btn_edit = `<button type="button" class="btn btn-sm mb-1 btn-primary btn-update-article" data-id="${res.id}" data-judul="${res.judul}" data-konten="${encodeURIComponent(res.konten)}" data-toggle="modal" data-target="#crudModal"><i class="fas fa-pen"></i></button>`
        ...
        $(document).on('click', ".btn-update-article", function () {
            ...
            articleContent.setData(decodeURIComponent($(this).attr('data-konten')))
            ...
            callApi("POST", url, data, function (req) {
                ...
                if (req.error == true) {
                    Swal.fire(
                        ...
                        $('.btn-confirm-update-article').html("Update")
                        $('.btn-confirm-update-article').attr('disabled', false)
                    })
                } else {
                    Swal.fire(
                        'Diupdate!',
